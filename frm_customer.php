...
<body class="sb-nav-fixed">
    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid px-4 py-5 mx-auto" style="width: 1100px;">
                <div class="card mb-4">
                    <div class="card-header">
                        <center>
                            <i class="fa-solid fa-user-gear"></i>
                            Customer ID: <?php echo $session_user_id; ?>
                        </center>
                    </div>
                    <div class="card-body">
                        <form class="row g-3 p-3" action="update_customer_account" method="POST">
                            <div class="col-md-6">
                            ...
                            <div class="col-12">
                                ...
                                <a href="customer" class="btn btn-success"><i class="fa-solid fa-backward-fast"> </i> Get Back to Your Account</a>
                            </div>
                        </form>
                    </div>
                </div>
